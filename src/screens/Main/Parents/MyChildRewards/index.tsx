...
const MyChildRewards = ({ navigation }: any) => {
  const RedemsData = [
    {
      icon: images.redem,
    ...
    return (
      <View style={{ alignItems: "center", gap: sizeHelper.calHp(10) }}>
        ...
        <CustomText
          ...
          size={25}
        />
        <CustomText text={label} size={18} color={theme.colors.black + "60"} />
      </View>
    );
  };
  ...
  return (
    <>
      ...
      >
        ...
        >
          <TabHeader title={"My Child’s Rewards"} isNotification />
        </View>
              ...
              <View style={{ gap: sizeHelper.calHp(15) }}>
                ...
                >
                  {RedemsData.map((item, index) => {
                    return <RedemCard item={item} index={index} />;
                  })}
                </View>
              </View>
            </View>
