...
import { ShowOnData, taskCategoryData } from "../../../../utils/Data";
import DatePicker from "react-native-date-picker";
import CustomButton from "../../../../components/Button";

const AddNewBanner = ({ navigation, route }: any) => {
  ...
  const [tasksCategory, setTasksCategory] = useState(ShowOnData);
  ...
  return (
    <>
      ...
      >
        ...
        >
          <CustomHeader title={"Add New Banner"} />
